...
loadJsFileToTop(["$js_path$com/kits/qmeditor/qqmail/release/editor47d62d.js"]);
...
loadCssFile("$css_path$login/addAccount44a10d.css",true,p.document);
function P()
{
showInfo("\u53D1\u9001\u9A8C\u8BC1\u7801...");
...
{
var b=getTop(),a=arguments.callee;
b.loadCssFile("$css_path$login/addAccount44a10d.css",true,b.document);
...
c.loadCssFile("$css_path$login/addAccount44a10d.css",true,c.document);
...
var a={'comm2010.css':'$css_path$comm2010469107.css'};
return function(b){
var c=a[b];
return c&&getRes(c);
};
