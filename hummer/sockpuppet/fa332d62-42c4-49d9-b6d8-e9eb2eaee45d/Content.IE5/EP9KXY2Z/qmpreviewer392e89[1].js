...
if(!g[h])
{
g.loadJsFileToTop(["$js_path$qmplayer/player38b933.js"]);
}
g.waitFor(function(){
return !!g[h];
},function(i){
...
this._moOperator.enable({navbar:false,minibar:{minimize:w=="Music"},mainbar:{Video:1,Music:1}[this._msMode]||this._mbNoOpt?false:{parse2OnlineDoc:t.sParse2OnlineDocUrl?true:false,zoombtn:w=="Image"?true:"disable",rotate:w=="Image"?true:"disable",app:this._mbShowApp,next:r?false:(u?true:"disable"),prev:r?false:(v?true:"disable"),breakline:this._mbShowBreakLine?!r:false,send:!!this._moEvents.fFrwd?(t.bIsTimeout==1?"disable":true):false,list:r?false:s,info:t.oInfo,scan:d&&t.bIsTimeout!=1&&!!t.sTwoDCodeUrl,down:this._mbShowDownBtn?(!t.sDown?false:(t.bIsTimeout==1?"disable":true)):false}},{Document:true,Compress:true,Image:true}[this._calcViewerType(t)]);
...
break;
case "parse2OnlineDoc":
var r=this._moCurViewer.getFileInfo(),t=r.sParse2OnlineDocUrl;
...
var c=1500,d=0,g={minibar:{minimize:false,close:true},navbar:{nav:false},mainbar:{zoombtn:"disable",rotate:"disable",parse2OnlineDoc:false,prev:true,next:true,breakline:true,list:false,send:true,scan:true,down:true,info:false}};
e.init=function(h,j){
var k=this;
...
var e={mainbar:{zoombtn:"disable",rotate:"disable",parse2OnlineDoc:false,app:true,prev:true,next:true,breakline:false,list:true,send:false,scan:true,down:true,info:false}};
c.init=function(f){
var g=this;
