...
s=k.replace({jump:q.htmlEncode(r),img:p.innerHTML});
p.innerHTML="";
q.replaceHTML(l,s);
g=true;
}
...
else if(g.indexOf("://rescdn.qqmail.com/zh_CN/images/mo/DEFAULT2/")==-1)
{
if(!m)
{
var r=p.startContainer;
if(r.tagName=="IMG")
{
m=r;
}
...
if(r.nodeName=="#text")
{
if(r.previousSibling&&(!r.nextSibling||r.nextSibling&&r.nextSibling.tagName!="IMG")&&r.previousSibling.tagName=="IMG")
{
m=r.previousSibling;
}
else{
...
m=r.childNodes[p.startOffset];
}
}
}
else if(i.gbIsIE&&m.tagName=="BR"&&m.nextSibling)
{
m=m.nextSibling;
}
var n=h.getImgDom(m);
...
if(n.previousSibling&&(!(/^br$/i.test(n.previousSibling.tagName))||n.previousSibling.nodeType==3))
{
i.insertHTML(n,"beforeBegin","</br>");
}
else if(n.parentNode&&n.parentNode.tagName=="LI")
{
i.insertHTML(n,"beforeBegin","</br>");
}
if(n.nextSibling&&(n.nextSibling.nodeName!="#text"||n.nextSibling.length>0))
{
if(!n.nextSibling.nextSibling||!(/^br$/i.test(n.nextSibling.tagName))||n.nextSibling.nodeType==3)
{
i.insertHTML(n,"afterEnd","</br>");
}
n.nextSibling.nextSibling&&h._setCursorPos(n.nextSibling.nextSibling,0);
...
i.insertHTML(n,"afterEnd","</br></br>");
n.nextSibling&&h._setCursorPos(n.nextSibling.nextSibling,0);
}
}
}
catch(s)
...
b.prototype.loadFileToEditor=function(f,e){
if(!this._moLoaddingFile)
{
this._moLoaddingFile={};
}
...
if(g)
{
a.loadJsFile(a.getRes(i),false,this.getEditDoc(),e);
this._moLoaddingFile[i]=a.now();
}
}
return this;
...
b.CONST.FILES={"$js_path$/com/kits/qmeditor/base/js/editor_toolbar24e6b9.js":"Separate Bold Italic Underline FontName FontName FontSize ForeColor BackColor AlignMode Serial Indent Quot CreateLink SourceEdit Preview SpellCheck UploadEml","$js_path$/com/kits/qmeditor/base/js/editor_toolbar_plus24e6b9.js":"ClipImg Photo ScreenSnap Mo Music"};
b.CONST.FUNCLIST={};
...
b.CONST.FUNCLIST.NOTE=(getTop().gbIsIE||getTop().gbIsEdge)?{toolbar:"Bold Italic Underline | FontName FontSize ForeColor BackColor | AlignMode Serial Indent Quot | CreateLink SourceEdit",tbExtern:"Photo ScreenSnap Mo"}:{toolbar:"Bold Italic Underline | FontName FontSize ForeColor BackColor | AlignMode Serial Indent Quot TaskList | CreateLink SourceEdit",tbExtern:"Photo ScreenSnap Mo"};
...
a.callBack.call(h,h._fView,[z,j,C,parseInt(z.style.left)]);
};
var k=function(D){
var I=parseInt(z.style.left),H=I+(D.clientX-n),G=false;
if(H<-5||H>65)
{
G=true;
}
...
{
var s=f.getMapFunc();
s._doDefaultClick.call(s,{searchKeyword:getTop().htmlEncode(a.attr(z,"skwd")||""),title:a.attr(z,"stitle")||"",center:getTop().htmlEncode(a.attr(z,"center")||""),pos:getTop().htmlEncode(a.attr(z,"pos")||""),zoom:parseInt(getTop().htmlEncode(a.attr(z,"zoom"))||15),posDesc:getTop().htmlEncode(a.attr(z,"desc")||"")});
}
break;
}
case "jumptomap":
...
a.preventDefault(j);
var B=a.attr(z,"src");
if(/^https:\/\/apis.map.qq.com\/uri\/v1\/marker\?/.test(B))
{
...
default:
{
a.callBack.call(h,h._fView,[z,j,C]);
}
}
}
if(!a.isShow(u))
...
p=o[h]?o[h].replace({"link":((i&&i.href)||""),"images_path":k._msResPath,"imgcontent":q,"img_map":getTop().htmlEncode(getTop().attr(j,"jump"))}):"";
...
this._moEditorAreaObj&&a.evalCss(f,this._moEditorAreaObj.ownerDocument,"qmNetDisk");
QMEditor.getTopWin().waitFor(function(){
return h.getEditBody();
},function(i){
if(i)
{
h._initEvents(h.getEditBody());
}
});
};
QMEditor.prototype.appendContent=function(h){
var j=this;
if(j.getContentType()=='text')
{
j.setContent(j.getContent()+h);
}
else{
var n=QMEditor.getTopWin();
if(j.getEditMode()=='html')
{
var l=j.getContentTags('sign')[0];
if(l)
{
a.insertHTML(l,'beforeBegin',h);
return this;
}
var m=j.getContentObj("QQMAILSTATIONERY");
if(m)
{
a.insertHTML(m,'beforeEnd',h);
return this;
}
var k=j.getContentTags('includetail')[0];
if(k)
{
a.insertHTML(k,'beforeBegin',h);
return this;
}
j.setContent(j.getContent()+h);
}
...
var i=false;
var p='';
var q=o.replace(/<includetail>[\s\S]*<\/includetail>/g,function(r){
p+=r;
return '';
});
q=q.replace(/<sign +signid=\S+? +nreadytime=\S+? *>[\s\S]*<\/sign>/,function(r){
i=true;
return h+r;
});
if(!i&&q.indexOf('QQMAILSTATIONERY')!=-1)
{
q=q.replace(/<\/td>[\s\S]*?$/,function(r){
i=true;
return h+r;
});
}
...
o=o.replace(/<includetail>[\s\S]*<\/includetail>/,function(r){
i=true;
return h+r;
});
}
...
QMEditor.prototype.insertNetDiskFile=function(i,h){
var l=this,j=l.getEditWin(),m=QMEditor.getTopWin(),k=[];
a.E(i,function(n){
if(n.sFakeId&&a.S(n.sFakeId,j))
{
m.showInfo("\u90E8\u5206\u6587\u4EF6\u91CD\u590D\uFF0C\u5DF2\u81EA\u52A8\u6392\u9664");
return;
}
k.push(n);
});
k.length&&this._getShareLink(k,function(n){
this.focus(0,a.parents("table",a.S(c,this.getEditWin()))[0].nextSibling);
h&&h.call(this);
});
};
QMEditor.prototype.updateNetDiskFile=function(h,j,i){
var m=this,l=j.oQueryData||j,k=m.getEditWin();
a.E(l,function(n){
var o=a.S(n.sFakeId,k),p=a.finds("td",o);
if(h)
{
p[0].style.cssText="";
p[1].style.cssText="";
o.href=n.sLink;
a.attr(o,"errorid")&&o.removeAttribute("errorid");
m._updateBtn(o,1);
}
else{
!a.attr(o,"href")&&a.attr(o,"errorid",j.nErrorID);
m._updateBtn(o,0);
}
});
i&&i.call(this);
...
var h=this,i=QMEditor.getTopWin();
return i.QMNetDisk&&i.QMNetDisk.sharelink.isRunning();
};
QMEditor.prototype.shareLinkErrorCnt=function(){
var h=false,i=0;
a.E(a.finds("a[ui-type='shareLink']",a.S(c,this.getEditWin())),function(j){
if(!a.attr(j,"href")||a.attr(j,"errorid"))
{
h=true;
i++;
}
});
debug("hasErrorShareLink:::"+h);
return i;
};
QMEditor.prototype.hasTODOShareLink=function(){
var h=this,i=QMEditor.getTopWin();
return i.QMNetDisk&&i.QMNetDisk.sharelink.hasTODOFile();
};
QMEditor.prototype.rmNetDiskAction=function(){
var m=this,k=m.getEditWin(),n=QMEditor.getTopWin(),j=a.S(c,k),i=a.finds("a[ui-type='shareLink']",j),l=[];
a.E(i,function(o){
if(!a.attr(o,"href")||a.attr(o,"errorid"))
{
l.push(o);
}
});
...
{
var h=l.shift();
!a.attr(h,"href")&&h.parentNode.removeChild(h);
h=d;
}
n.QMNetDisk&&n.QMNetDisk.sharelink.clean();
};
QMEditor.prototype.rmNetDiskID=function(){
a.E(a.finds('div[ui-type="shareField"]',this.getEditBody()),function(h){
h.removeAttribute("id");
h.parentNode.removeAttribute("id");
});
};
QMEditor.prototype.doCallEditorAction=function(i,h){
if(i!="Photo"&&i!="Mo")
{
return;
}
var j=this.getTbExternInfo(i).funcObj;
j.showMenu(false,{sName:"webapns",nArrowPos:null});
};
QMEditor.prototype._updateBtn=function(i,h){
var k=a.finds("td[ui-type='iconInit']",i)[0],j=a.finds("td[ui-type='iconFail']",i)[0],l=a.finds("td[ui-type='iconSucc']",i)[0];
if(!k||!j)
{
return;
}
...
QMEditor.prototype._insertHTML=function(j,h,i){
var m=this,k=m.getEditWin();
if(document.selection)
{
if(i)
{
a.insertHTML(i,"beforeEnd",j);
}
else{
var l=k.document.selection.createRange();
l.pasteHTML(j);
l.collapse(false);
l.select();
}
...
m.execCmd("insertHTML",j,function(){
h&&h.call(m);
});
}
};
QMEditor.prototype._initEvents=function(i){
var h=QMEditorAdapter,l=this,m=QMEditor.getTopWin(),k=function(o){
var r=h.getEventTarget(o),q=h.parents("a[ui-type='shareLink']",r)[0],p;
if(h.attr(r,"ui-type")=="shareLink"||q)
{
p=q||r;
}
return p;
},j=function(o){
var r=h.finds("a[ui-type='shareLink']",o),q=o.parentNode;
if(!r.length)
{
q.removeChild(o);
if(!q.childNodes.length)
{
var p=h.parents("table",q)[0];
...
var r=h.finds("td[ui-type='iconSucc'] img[ui-type='goIcon']",p)[0],q=h.finds("td[ui-type='iconSucc'] img[ui-type='delIcon']",p)[0];
if(r)
{
h.show(r,!o);
r.style.visibility=!o?"":"hidden";
r.width=r.height=(!o?14:0);
}
if(q)
{
h.show(q,o);
q.style.visibility=o?"":"hidden";
q.width=q.height=(o?14:0);
}
};
h.addEvents(i,{mousedown:function(o){
var p=k(o);
if(p)
{
var s=h.getEventTarget(o);
if(h.attr(s,"ui-type")=="delIcon")
{
var r=h.parents("a[ui-type='shareLink']",s)[0],q=r.parentNode;
q.removeChild(r);
j(q);
l.focus();
q=r=d;
...
else if(h.attr(s,"ui-type")=="retryIcon")
{
if(m.QMNetDisk)
{
var r=h.parents("a[ui-type='shareLink']",s)[0],t=h.attr(r,"errorid");
m.QMNetDisk.sharelink.retry(t,function(){
h.E(h.finds("a[errorid='"+t+"']",r.parentNode),function(u){
l._updateBtn(u,-1);
});
});
}
...
QMEditor.prototype._getContainer=function(h,i,j){
var m=this,l=m.getEditWin(),n=i||c;
if(!a.S(n,l))
{
var o=j||(['<table cellspacing="0" cellpadding="0" border="0" style="font-size:12px;">','<tr><td ui-type="shareCon" id="',n,'">','</td></tr>','</table>'].join(""));
o+=QMEditor.getBreakLine();
var k=a.S("QQMAILSTATIONERY",l);
if(k)
{
m.focus(0,k.firstChild||k);
}
else{
m.focus();
}
m.execCmd(a.gbIsIE?"delete":"insertHTML",a.gbIsIE?null:"&nbsp;",function(){
m._insertHTML(o,function(){
h&&h.call(m,a.S(n,l));
});
});
}
...
var b='qqmail_online_doc_link_id';
QMEditor.prototype.insertOnlineDocFileByKey=function(h){
var j=this,i=j.getEditWin(),k=QMEditor.getTopWin();
k.QMAjax.send("/cgi-bin/docedit_read?t=online_doc.json",{content:k.T("key=$sFileId$").replace({sFileId:h}),method:"POST",onload:function(l,m){
try{
var n=k.evalValue(m);
oFileInfo=n.oFileInfo;
j.insertOnlineDocFile([{sKey:oFileInfo.sFileId,sName:oFileInfo.sFileName,sNoSuffixName:/d_/.test(oFileInfo.sFileId)?oFileInfo.sFileName:(oFileInfo.sFileName.slice(0,oFileInfo.sFileName.lastIndexOf('.'))),sLink:"https://mail.qq.com/cgi-bin/docedit_read?func=3rdread&key="+oFileInfo.sFileId}]);
}
catch(o)
{
}
...
QMEditor.prototype.insertOnlineDocFile=function(i,h){
var k=this,j=k.getEditWin(),l=QMEditor.getTopWin();
this._getOnlineDocLink(i,function(m){
var n=a.parents("table",a.S(b,this.getEditWin()))[0];
this.focus(0,n.nextSibling);
l.gbIsChrome&&l.attr(n,'contenteditable','false');
h&&h.call(this);
k._initOnlineDocLinkEvents();
});
};
QMEditor.prototype._initOnlineDocLinkEvents=function(){
var o=this,n=o.getEditWin(),p=QMEditor.getTopWin();
var m=a.parents("table",a.S(b,n))[0];
var j=37,l=38,k=39,i=40,h=8;
!p.gbIsChrome&&p.addEvent(n,'keydown',function(q){
var v=n.getSelection();
var t=false;
var w=0;
var r=0;
if(p.isObjContainTarget(m,v.focusNode)||v.focusNode.nodeType==3&&p.isObjContainTarget(m,v.focusNode.parentNode))
{
var s=g(m);
if(q.keyCode==j||q.keyCode==l)
{
t=true;
w=s;
r=s;
}
else if(q.keyCode==k||q.keyCode==i)
{
t=true;
w=s+1;
r=s+1;
...
u.setStart(m.parentNode,w);
u.setEnd(m.parentNode,r);
v.removeAllRanges();
v.addRange(u);
}
p.preventDefault(q);
...
QMEditor.prototype._getOnlineDocLink=function(i,h){
var k=this,l=QMEditor.getTopWin(),m=b+'_suffix',j=k.getEditWin(),n=l.TE(['<style>','@media (max-width: 415px) {','.eml_frame {','padding: 5px 5px 20px!important;','}','.eml_frame_cnt {','width: 100%!important;','}','.eml_smallAvatar {','width: 24px!important;','height: 24px!important;','}','.eml_userName {','font-size: 17px!important;','line-height: 24px!important;','}','.eml_frame_cnt_main {','padding-top: 15px!important;','font-size: 17px!important;','line-height: 28px!important;','padding-bottom: 30px!important;','}','.eml_link {','font-size: 14px!important;','line-height: 28px !important;','height: 28px !important;','}','}','</style>','$@$for($oList$)$@$','<a ui-type="onlineDocLink" id="$sKey$" style="display: block;width: 100%;text-decoration: none;cursor: pointer;" id="$id$"  href="$sLink$" target="_blank">','<table class="eml_frame_cnt" cellspacing="0" cellpadding="0" style="width: 450px; table-layout:fixed;background-color:#FFF;border-radius: 5px; border: 1px solid #E0E0E0;-webkit-box-shadow: 0 0 10px 0 rgba(0,0,0,0.06);-moz-box-shadow: 0 0 10px 0 rgba(0,0,0,0.06);box-shadow: 0 0 10px 0 rgba(0,0,0,0.06);">','<tr>','<td style="padding: 40px 30px 0;">','<table class="" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;width: 100%;">','<td style="width: 22px;height: 22px;padding: 0;vertical-align: top;font-size: 0;">','<img class="eml_smallAvatar" width="22" height="22" style="width: 22px;height: 22px;border-radius: 2px;vertical-align: top;"','src="$_root_.iconURL$">','</td>','<td class="eml_userName" style="font-family: PingFangSC-Regular,\'lucida Grande\',Verdana,\'Microsoft YaHei\';font-size: 14px;line-height: 22px;color: #242A2C;padding: 0 0 0 10px;">$_root_.nickname$</td>','</table>','</td>','</tr>','<tr>','<td class="eml_frame_cnt_main" style="padding: 10px 30px 35px;font-size: 14px;line-height:20px;color: #242A2C;font-weight: bold;vertical-align: top;font-family: PingFangSC-Regular,\'lucida Grande\',Verdana,\'Microsoft YaHei\';">','<span style="font-weight: normal;">','$@$if(/^d_/.test($sKey$))$@$','\u9080\u8BF7\u4F60\u4E00\u8D77\u52A0\u5165\u6587\u4EF6\u5939','$@$else$@$','\u9080\u8BF7\u4F60\u4E00\u8D77\u7F16\u8F91\u5728\u7EBF\u6587\u6863','$@$endif$@$','</span>','\u300E$@$eval getTop().htmlEncode($sNoSuffixName$) $@$\u300F','</td>','</tr>','<tr>','<td  style="padding: 10px 30px 0; background: #F1F1F1;">','<div class="eml_link" style="width: 90px; height: 22px;line-height: 22px;text-align:center;border: 1px solid #CCC;background: #FFF;border-radius: 2px; letter-spacing: 0.14px;color:#33312E;text-decoration: none;font-family: PingFangSC-Regular,\'lucida Grande\',Verdana,\'Microsoft YaHei\';font-size: 12px;">\u67E5\u770B\u8BE6\u60C5</div>','</td>','</tr>','<tr>','<td style="padding: 10px 30px 0; background: #F1F1F1;font-size: 0;line-height: 0;">','</td>','</tr>','</table>','</a>','$@$endfor$@$']).replace({id:m,iconURL:'https://mail.qq.com/cgi-bin/getqqicon?pixel=128&u='+l.g_encryptuin,nickname:l.goUserInfo&&l.goUserInfo.get("RealUserNick")||l.getUin(),oList:i});
k._getContainer(function(o){
this._moveToEnd(a.S(m,j)||o,function(p){
this._insertHTML(n,function(){
h&&h.call(this);
},p);
});
},b,['<div class="qmbox"><table cellspacing="0" cellpadding="0" border="0">','<tr><td style="padding: 20px;" ui-type="shareCon" class="eml_frame" id="',b,'">','</td></tr>','</table></div>'].join(''));
};
QMEditor.prototype.getOnlineDocKeys=function(){
var h=[],i='';
a.E(a.finds("a[ui-type='onlineDocLink']",a.S(b,this.getEditWin())),function(j){
if(a.attr(j,"href")&&(i=a.attr(j,"id")))
{
h.push(i);
}
});
...
QMEditor.prototype._moveToEnd=function(i,h){
var o=this,l=o.getEditWin(),k=l.document,n,m,j=k.createElement("span");
j.innerHTML="&nbsp;";
if(document.selection)
{
i.appendChild(j);
...
QMEditor.prototype._warpShareLinkTitle=function(h,i){
var j=this,m=h.sType,l=c+m,k=QMEditor.getTopWin();
return k.T(['<div ui-type="shareField" id="$id$" style="padding-bottom:10px;background:#f2f2f2;border-radius:5px;">','<div unselectable="on" ','style="margin-bottom:8px;padding:8px;color:#a0a0a0;border-bottom:1px solid #ccc;-moz-user-select:none;-webkit-user-select:none;-o-user-select:none;">','<img src="$sDomainImgPath$/zh_CN/htmledition/images/icon_$sAlias$.png" ','width="16" height="16" style="vertical-align:middle;margin:-2px 4px 0 0;*margin-top:0;" notForEdit="1" />','<span style="font-size:12px;">$sLabel$\u7684\u6587\u4EF6</span>','</div>','$HTML$','</div>']).replace(a.extend({sDomainImgPath:location.host.indexOf("dev")==0?"//dev.mail.qq.com":"//mail.qq.com",id:l,HTML:i},k.QMNetDisk?k.QMNetDisk.getInfo(m):{sLabel:"\u5FAE\u4E91",sAlias:"weiyun"}));
};
QMEditor.prototype.isUsedFSEditor=function(){
var h=this;
if(!h.getEditorCustomVar)
{
getTop().LogKV({sValue:'editor|error|no_func|geteditorcustomvar'});
return;
}
return h.getEditorCustomVar('FullScreenToolbar.bUseFullEdtior');
};
