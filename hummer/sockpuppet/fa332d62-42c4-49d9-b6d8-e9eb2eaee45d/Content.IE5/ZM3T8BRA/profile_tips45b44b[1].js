...
_goStatic._TEMPLATE._OPERPANEL=TE(['$@$if($btnnum$!=0)$@$','<div class="profile_ope"></div>','<div class="profile_ope profile_ope_ab">','<table class="pro_ope ','$@$if($filinghtml$!="" || $rejectionhtml$!="")$@$','$@$if($filinghtml$!="" && $rejectionhtml$!="")$@$',' pro_ope_four','$@$else$@$',' pro_ope_three','$@$endif$@$','$@$endif$@$','"><tr>','$@$if($rejectionhtml$!="")$@$','<td test="jostinsu" class="reject_td','$@$if($addrvip$=="" && $filinghtml$=="" && $addrinfohtml$=="")$@$',' pro_ope_last','$@$endif$@$','">','$rejectionhtml$','</td>','$@$endif$@$','$addrinfohtml$','$@$if($filinghtml$!="")$@$','<td class="filing_td pro_ope_last">$filinghtml$</td>','$@$endif$@$','</tr></table>','</div>','$@$endif$@$']);
...
_goStatic._TEMPLATE._WWPROFILE_DETAIL=TE(['<div class="profile_inner">','<img src="$icon$" title="" class="iconMask_gray" />','<div class="nowrap">','<span id="span_displayname_$email$" class="green bold b_size txtflow ','$@$if($addrvip$=="")$@$','tip_dispname_long ','$@$else$@$','tip_dispname_short ','$@$endif$@$','" title="$corp_username$" ','$@$if($addrvip$!="")$@$','style="float: left; margin-right: 4px;"','$@$endif$@$','>','$corp_username$','</span>','$@$if($addrvip$!=""&&$btnnum$!=0)$@$','<span class="tip_iclist_ico_wrap" id="addVipAddr_$email$" ','style="vertical-align: 0;*vertical-align: -2px;_vertical-align: -3px;','$@$if($addrvip$=="true")$@$','display: none;','$@$endif$@$','"','>','<span class="tip_iclist_ico_btn" title="\u8BBE\u4E3A\u91CD\u8981\u8054\u7CFB\u4EBA"></span>','</span>','<span class="tip_iclist_ico_wrap tip_iclist_ico_wrap_vip" id="delVipAddr_$email$" ','style="vertical-align: 0;*vertical-align: -2px;_vertical-align: -3px;','$@$if($addrvip$=="false")$@$','display: none;','$@$endif$@$','"','>','<span class="tip_iclist_ico_btn" title="\u79FB\u9664\u91CD\u8981\u8054\u7CFB\u4EBA"></span>','</span>','$@$endif$@$','</div>','<div class="graytext txtflow" title="$corp_name$" style="padding-bottom: 8px;">$corp_name$</div>','$@$if($corp_job$!="")$@$','<div class="graytext txtflow" title="$corp_job$">$corp_job$</div>','$@$endif$@$','<a href="javascript:;" class="ww_signature_profileQrcode_wrap">','<div class="ww_signature_profileQrcode_btn"></div>','<div class="ww_signature_profileQrcode_ext">','<div class="ww_signature_profileQrcode_img"><img src="$url_qrcode$" alt="\u5546\u52A1\u4E8C\u7EF4\u7801" /></div>','<div class="graytext ww_signature_profileQrcode_text">\u5FAE\u4FE1\u626B\u7801\u8054\u7CFB\u6211</div>','</div>','</a>','<div class="profile_inner_info">','$@$if(!$issys$)$@$','<a href="javascript:;" onclick=\'getTop().QMProfileTips.oper("mailTo","$_id$","$email$", "$showinfo$", "$jsname$")\' class="graytext pointer accountFrom" title="\u7ED9TA\u5199\u4FE1" style="margin-right:9px;">$dispemail$</a>','$@$else$@$','<span class="graytext" title="$dispemail$" style="margin-right:9px;">$dispemail$</span>','$@$endif$@$','$@$if($email$!="10000@qq.com")$@$','<a class="pointer" ck="checkContactsEmails" style="display:inline-block;" href="/cgi-bin/mail_list?sid=$sid$&s=searchcontact&sender=','$@$eval encodeURIComponent($email$)$@$','&receiver=$@$eval encodeURIComponent($email$)$@$','&name=$name$&matchtype=include&folderid=all&page=0&AddrID=$AddrId$&grpid=$grpid$&category=all&from=profile&loc=profile,searchcontact,0,0">\u5F80\u6765\u90AE\u4EF6</a>','$@$endif$@$','</div>','</div>',_goStatic._TEMPLATE._OPERPANEL]);
_goStatic._TEMPLATE._INFOCARD=TE(['<div class="profileTip" id="infocard_$_id$" style="display:none;">','<div class="infoArrowUp" id="infoarrowup_$_id$" style="display:none;"></div>','$@$if($role$=="corpprofile")$@$','$@$for($_oFeeds$)$@$',_goStatic._TEMPLATE._CORP_PROFILETIPS_DETAIL,'$@$endfor$@$','$@$else$@$','<div class="tipWrap $@$if($_oFeeds.length$>1)$@$ tipWrapWithArrow $@$endif$@$">','<div class="tipAll" style="width:$_nTotalWidth$px;left:-$_nCurrentLeft$px">','$@$for($_oFeeds$)$@$','<div class="tipInner">','$@$if($role$=="wwprofile")$@$',_goStatic._TEMPLATE._WWPROFILE_DETAIL,'$@$else$@$',_goStatic._TEMPLATE._INFOCARD_DETAIL,'$@$endif$@$','</div>','$@$endfor$@$','</div>','<div class="tipSwitch">','<div class="tipAllLeft $@$if($_bIsNeedLeft$==false)$@$ tipAllLeft_disabled $@$endif$@$"></div>','<div class="tipAllRight $@$if($_nIsNeedRigth$==false)$@$ tipAllRight_disabled $@$endif$@$"></div>','</div>','</div>','$@$endif$@$','<div class="infoArrowDown" id="infoarrowdown_$_id$" style="display:none;"></div>','</div>']);
...
{
if(!_oAddrSpans[i].getAttribute('ignore_profile_tips'))
{
...
if(_oWeworkAddrs.length)
{
var _sMailid=_oSelf._sMailid;
var _oTriggerDom=_oSelf._moTriggerDom;
_oSelf._mbBuildingInfoCard=true;
_oTop.weworkSignature.getProfileInfo(_oWeworkAddrs,_sMailid,function(_aoError,_aoRetMap){
_oSelf._mbBuildingInfoCard=false;
if(_oTriggerDom!==_oSelf._moTriggerDom)
{
return;
}
_oTop.E(_aoFeeds,function(_aoItem){
var _oInfo=_aoRetMap[_aoItem.email];
if(_oInfo&&_oInfo.mail_business_card_status==3)
{
extend(_aoItem,{'icon':htmlEncode(_oInfo.url&&_oInfo.url.replace(/^http:/,'https:')||_oTop.getRes('$images_path$wework/avatar454469.png')),'corp_username':htmlEncode(_oInfo.name),'corp_name':htmlEncode(_oInfo.corp_name),'corp_job':htmlEncode(_oInfo.job),qrcode_icon:_oTop.getRes('$images_path$wework/wework_small_logo_2x4538ba.png'),url_qrcode:_oTop.htmlEncode('https://mail.qq.com/cgi-bin/generate_twodimcode?action=mail_buss_card&in=100&out=100&url='+encodeURIComponent(_oInfo.url_for_gen_qrcode))});
}
else{
_oInfo.role='';
}
...
var _oInfoCard=_oSelf._moInfoCard=S('infocard_'+_sDomId,_oSelf._moWin);
_oSelf._bindEvent({"targetDom":_oInfoCard,"datas":_aoFeeds,"totalWidth":_nTotalWidth});
_oSelf._setStatus(2);
});
}
else if(_sShowInfo==3||_sShowInfo==6)
{
insertHTML(_oSelf._moWin.document.body,'afterBegin',_goStatic._TEMPLATE._INFOCARD.replace(_oData));
var _oInfoCard=_oSelf._moInfoCard=S('infocard_'+_sDomId,_oSelf._moWin);
_oSelf._bindEvent({"targetDom":_oInfoCard,"datas":_aoFeeds,"totalWidth":_nTotalWidth});
...
var _sEmail=_aoFeeds[0].email,_sUin=_aoFeeds[0].uin;
_oSelf._mbBuildingInfoCard=true;
...
_oFeed=extend({'uin':_sUin,'qqnum':_sQQNum,'email':_sEmail,'name':_sNameURI,'dispname':_sNameHtml,'attrname':_sNameAttrHtml,'jsname':_sNickNameNE,'dispemail':_wraparound(_sEmail),'showinfo':_sShowInfo,'sid':getSid(),'images_path':getPath('image'),'img_path':getPath('image'),'btnnum':_nBtnNum,'arrow':_oTriggerDom.tagName=="IMG"?0:1,'bmail':_bMail,'bsms':_bSms,'bansms':_bBanSmsByFol,'brss':_bRss,'rssdomain':typeof (gsRssDomain)=="undefined"?"":gsRssDomain,'role':_sRole,"mailid":_sMailid,"qqfriend":_sQQFnd,'home':_sHome,'addrinfohtml':_sAddrInfoHtml,'rejectionhtml':_sRejectionHtml,'filinghtml':_sFilingHtml,'nickname':_sNickName,'AddrId':attr(_oDomEdit,"addrid")||"",'addrvip':_sAddrvip?(_sAddrvip=='true'||_sAddrvip=='1'?'true':'false'):'','addrvipid':attr(_oTriggerDom,'addrid')||"",'issys':_bAdminEmail,'icon':"/cgi-bin/getqqicon?uin="+_sUin+"&mode=newaddr&mailaddr="+encodeURI(_sEmail)+"&sid="+_oTop.getSid()},_oFeed);
return _oFeed;
};
